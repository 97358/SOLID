...
* [System.Data.SqlClient](https://learn.microsoft.com/pt-br/dotnet/api/system.data.sqlclient?view=windowsdesktop-9.0) - Foi utilizado esse namespace no .NET Framework para acessar e manipular dados em um banco de dados SQL Server.
